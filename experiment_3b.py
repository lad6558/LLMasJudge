...
from core_3b import evaluate_all_responses
import asyncio
from tqdm import tqdm

async def run_experiment(num_trials: int = 10, scale: int = 10, cutoff: int = 80):
    """
    Run experiment 1b: Testing model size vs judgment variance across different temperatures
    ...
    # Create exp3b subdirectory
    exp_dir = results_dir / "exp3b"
...
def main():
    parser = argparse.ArgumentParser(description='Run experiment 1b: Testing model size vs judgment variance')
