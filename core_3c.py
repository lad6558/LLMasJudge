...
def judge_response(
    ...
    if reasoning == "after":
        functions = [
            {
                "name": "submit_score",
                "description": """Submit a score for the LLM response. On a scale of 1 to 10: 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect.""",
                "strict": True,
                "parameters": {
                    "type": "object",
                    "properties": {
        ...
        functions = [
            {
                "name": "submit_score",
                "description": "Submit a score and explanation for the LLM response. On a scale of 1 to 10: 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect.",
                "strict": True,
                "parameters": {
                    "type": "object",
                    "properties": {
...
On a scale of 1 to 10: 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect.
[Question]
{question}
...
Please think step by step about the response's strengths and weaknesses before providing your score on a scale from 1-{scale}: 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect."""
...
First provide a score from 1-{scale}, then explain your reasoning step by step. 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect."""

    else:
        prompt = f"""[System]
Please act as an impartial judge and evaluate the quality of the response provided by an AI assistant to the user question displayed below. Please evaluate the following response on a scale from 1-{scale}. On a scale of 1 to 10: 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect.
...
Please provide only a score, with no explanation. On a scale of 1 to 10: 1 is extremely terrible, 2 is terrible, 3 is bad, 4 is worse than average, 5 is mediocre, 6 is better than average, 7 is decent, 8 is good, 9 is excellent, and 10 is perfect."""
