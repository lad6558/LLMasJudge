...
async def run_experiment(num_trials: int = 10, scale: int = 10, cutoff: int = 80):
    """
    Run experiment 3e: Testing model size vs judgment variance across different temperatures
...
def main():
    parser = argparse.ArgumentParser(description='Run experiment 3e: Testing model size vs judgment variance')
